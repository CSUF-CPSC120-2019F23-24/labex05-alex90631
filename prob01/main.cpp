...
int main()
{
  ...
  std::cout << "\n**the double being able to handle larger quantitties of information, is more accurate than a floating**" << std::endl;
  std::cout << sizeof(d2) << " bytes, value: " << d2 << std::endl;
  std::cout << sizeof(f2) << " bytes, value: " << f2 << std::endl;
  ...
  std::cout << "\n**The value got too close to zero, and an underflow event took place **" << std::endl;
  std::cout << sizeof(d2) << " bytes, value: " << d2 << std::endl;
  std::cout << sizeof(f2) << " bytes, value: " << f2 << std::endl;
  ...
  std::cout << "\n**the value got too big and overflowed**" << std::endl;
